...
public class bbi_fy extends AppCompatActivity {
    ...
    private void getURLs(final String div) {
        final AlertDialog dialog = new AlertDialog.Builder(bbi_fy.this)
                .setTitle("BBI " + div)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            {
                                Toast.makeText(bbi_fy.this, "Could not fetch URL", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch(JSONException e)
                        {
                            Toast.makeText(bbi_fy.this, "JSON Exception " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                        catch(Exception ex)
                        {
                            Toast.makeText(bbi_fy.this, "Exception: " + ex.toString(), Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(bbi_fy.this, "Volley Error: " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void displayWebView(int itemID)
    {
        if(itemID == R.id.present)
        {
            ...
            Toast.makeText(bbi_fy.this, div + "BBI PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
           ...
           // alertBuilder.setTitle(div + " BBI");
            ...
            Toast.makeText(bbi_fy.this, div+" BBI ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
    ...
    public void showMessage(String title,String message)
    {
        ...
        {
            AlertDialog.Builder builder=new AlertDialog.Builder(bbi_fy.this);
        ...
        if(title.equals("Alert"))
        {
            ...
            builder.setNegativeButton("Close", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent in = new Intent(bbi_fy.this,bscit.class);
                    startActivity(in);
                    finish();
                }
            });
