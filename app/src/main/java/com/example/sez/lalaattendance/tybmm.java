...
public class tybmm extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.present)
        {
            ...
            webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSdjjTaJEzrdnEMMLr76NpgCLLWFstlFnhTcLBALyGFReUMI2Q/viewform");
            Toast.makeText(tybmm.this, "TY BMM PRESENT SELECTED", Toast.LENGTH_SHORT).show();

        }
        if(id == R.id.sheet)
        {

            String url = "https://docs.google.com/spreadsheets/d/11LpeZiX35H-4QcMNWMPZfI968665s3sQ91yTZ6R6wvs/edit#gid=1583968220";
...
//            startActivity(i);
            ...
            Toast.makeText(tybmm.this, "TY BMM ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
