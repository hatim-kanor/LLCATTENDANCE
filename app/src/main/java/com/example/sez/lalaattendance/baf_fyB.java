...
public class baf_fyB extends AppCompatActivity {
    private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.baf_fy_b);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.present)
        {
            ...
            webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSdvGDPQI2giOMbjvCo2kXgpC6TZ6dXepCP1VQ-FcFwPErFNXA/viewform");
            Toast.makeText(baf_fyB.this, "FY BAF PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
           ...
           WebView wv = (WebView) view.findViewById(R.id.view);
            ...
            Toast.makeText(baf_fyB.this, "FY BAF ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
