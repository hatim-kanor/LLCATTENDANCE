...
public class fybmm_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fybmm_a);
        ...
        actionBar.setTitle(year + " BMM " + div);
    ...
    private void getURLs(final String div,final String year) {
        final AlertDialog dialog = new AlertDialog.Builder(fybmm_A.this)
                .setTitle(year + "BMM " + div)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            {
                                Toast.makeText(fybmm_A.this, "Could not fetch URL", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch(JSONException e)
                        {
                            Toast.makeText(fybmm_A.this, "JSON Exception " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                        catch(Exception ex)
                        {
                            Toast.makeText(fybmm_A.this, "Exception: " + ex.toString(), Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(fybmm_A.this, "Volley Error: " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void displayWebView(int itemID)
    {
        if(itemID == R.id.present)
        {
            ...
            Toast.makeText(fybmm_A.this, year + "BMM "+div + "PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
            ...
            Toast.makeText(fybmm_A.this, year + "BMM "+div + "ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
    ...
    public void showMessage(String title,String message)
    {
        ...
        {
            AlertDialog.Builder builder=new AlertDialog.Builder(fybmm_A.this);
        ...
        if(title.equals("Alert"))
        {
            ...
            builder.setNegativeButton("Close", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent in = new Intent(fybmm_A.this,bscit.class);
                    startActivity(in);
                    finish();
                }
            });
