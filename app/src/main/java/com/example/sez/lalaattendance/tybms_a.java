...
public class tybms_a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tybms_a);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.present)
        {
            ...
            webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSfyepgClMoX1wf5CAUF13yFim8kWVyWvXWI6NF366ePeWgLWQ/viewform");
            Toast.makeText(tybms_a.this, "TY BMS  PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
            ...
            Toast.makeText(tybms_a.this, "TY BMS  ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
