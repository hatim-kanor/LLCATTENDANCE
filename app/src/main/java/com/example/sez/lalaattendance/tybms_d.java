...
public class tybms_d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tybms_d);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.present)
        {
            ...
            webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSfIqB2kjkEn-tt7YNBEIwujqD_Lbjn3GYjWpJuU0FxTQhQs6w/viewform");
            Toast.makeText(tybms_d.this, "TY BMS  PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
            ...
            Toast.makeText(tybms_d.this, "TY BMS  ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
