...
public class baf_sy extends AppCompatActivity {
    ...
    private void getURLs(final String year) {
        final AlertDialog dialog = new AlertDialog.Builder(baf_sy.this)
                .setTitle(year+ " BAF")
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            {
                                Toast.makeText(baf_sy.this, "Could not fetch URL", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch(JSONException e)
                        {
                            Toast.makeText(baf_sy.this, "JSON Exception " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                        catch(Exception ex)
                        {
                            Toast.makeText(baf_sy.this, "Exception: " + ex.toString(), Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(baf_sy.this, "Volley Error: " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void displayWebView(int itemID)
    {
        if(itemID == R.id.present)
        {
            ...
            Toast.makeText(baf_sy.this, year + "BAF PRESENT SELECTED", Toast.LENGTH_SHORT).show();
...
//            startActivity(i);
            ...
            Toast.makeText(baf_sy.this, year+" BAF ONLINE SHEET SELECTED", Toast.LENGTH_SHORT).show();
        }
    ...
    public void showMessage(String title,String message)
    {
        ...
        {
            AlertDialog.Builder builder=new AlertDialog.Builder(baf_sy.this);
        ...
        if(title.equals("Alert"))
        {
            ...
            builder.setNegativeButton("Close", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent in = new Intent(baf_sy.this,baf.class);
                    startActivity(in);
                    finish();
                }
            });
